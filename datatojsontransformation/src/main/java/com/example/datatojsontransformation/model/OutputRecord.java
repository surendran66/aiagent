...
public class OutputRecord {
    ...
    public OutputRecord(String id, String recordId, String service, Sla sla, String receivedTime, String completedTime, double durationMinutes, boolean breached, String Owner) {
        this.id = id;
